...
public class MakeWordBank : MonoBehaviour {
    ...
    public GameObject toClick; // for tutorial clicking
            ...
            else if (stepOfTutorial == 15)
            {
                ...
                */
                ...
                {//"not set to an instance of an object"
                    //state is the statemanager instance of the canvas
                    //clickevent is the clickaction instance of the canvas
                    ...
                    Debug.Log("Pointer/System/Event: " + fpointer + ", " + pointerData);
                    eventListener.OnPointerClick(pointerData);

                    //clickEvent.OnPointerClick(cpointer.GetFalconEventData());

                    //Event Listener, state.GetCursorPosition(), Event.current, EventSystem.current, PointerInputModule.MouseButtonEventData, state.setSelected(object?);
                    //replaceTag(state.getSelected(), true);
                    //GameObject objectClicked = EventSystem.current.pointerCurrentRaycast.gameObject;
                }*/
