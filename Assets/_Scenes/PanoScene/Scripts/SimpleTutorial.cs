    ...
    void Update()
    {
        if (state.getState() == 4)
        {
            ...
            else if (step == 5)
            {
                ...
                if (counter == 0)
                {
                    text.text = "We'll start with the right direction.\n Unlock the cursor and move your hands to the right as far as you can stretch\n" +
                ...
                if (cursor.transform.localPosition.x > 87f)
                {
